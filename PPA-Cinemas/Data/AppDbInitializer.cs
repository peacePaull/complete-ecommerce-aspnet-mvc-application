                ...
                if (!context.Cinemas.Any()) 
                {
                    context.Cinemas.AddRange(new List<Cinema>()
                   {
                        ...
                        new Cinema()
                        {
                            ...
                            LogoURL = "https://github.com/peacePaull/complete-ecommerce-aspnet-mvc-application/blob/master/Images-For-Db-Initialize/Cinemas/Leicester_Square_Odeon.jpg",
                        ...
                        new Cinema()
                        {
                            ...
                            LogoURL = "https://github.com/peacePaull/complete-ecommerce-aspnet-mvc-application/blob/master/Images-For-Db-Initialize/Cinemas/Uci_kinowelt_logo.png",
                        ...
                        new Cinema()
                        {
                            ...
                            LogoURL = "https://github.com/peacePaull/complete-ecommerce-aspnet-mvc-application/blob/master/Images-For-Db-Initialize/Cinemas/RitzyCinemaBrixton.jpg",
                        ...
                        new Cinema()
                        {
                            ...
                            LogoURL = "https://github.com/peacePaull/complete-ecommerce-aspnet-mvc-application/blob/master/Images-For-Db-Initialize/Cinemas/Screen_on_the_green.jpg",
                        ...
                        new Cinema()
                        {
                            ...
                            LogoURL = "https://github.com/peacePaull/complete-ecommerce-aspnet-mvc-application/blob/master/Images-For-Db-Initialize/Cinemas/Prince_Charles_Cinema.jpg",
                ...
                if (!context.Actors.Any())
                {
                    context.Actors.AddRange(new List<Actor>() 
                    {
                        new Actor()
                        {
                            ...
                            ProfilePictureURL = "https://github.com/peacePaull/complete-ecommerce-aspnet-mvc-application/blob/master/Images-For-Db-Initialize/Actors/Tom_Cruise_by_Gage_Skidmore_2.jpg"
                        },
                        new Actor()
                        {
                            ...
                            ProfilePictureURL = "https://github.com/peacePaull/complete-ecommerce-aspnet-mvc-application/blob/master/Images-For-Db-Initialize/Actors/Miles_Teller.jpg"
                        },
                        new Actor()
                        {
                            ...
                            ProfilePictureURL = "https://github.com/peacePaull/complete-ecommerce-aspnet-mvc-application/blob/master/Images-For-Db-Initialize/Actors/Jennifer_Connelly.jpg"
                        },
                        new Actor()
                        {
                            ...
                            ProfilePictureURL = "https://github.com/peacePaull/complete-ecommerce-aspnet-mvc-application/blob/master/Images-For-Db-Initialize/Actors/Chris_Pratt.jpg"
                        },
                        new Actor()
                        {
                            FullName = "Bryce Dallas Howard",
                            Bio = "Bryce Dallas Howard (born March 2, 1981) is an American actress and director.",
                            ProfilePictureURL = "https://github.com/peacePaull/complete-ecommerce-aspnet-mvc-application/blob/master/Images-For-Db-Initialize/Actors/Bryce_Dallas_Howard.jpg"
                        },
                        new Actor()
                        {
                            FullName = "Benedict Cumberbatch",
                            Bio = "Benedict Timothy Carlton Cumberbatch CBE (born 19 July 1976) is an English actor.",
                            ProfilePictureURL = "https://github.com/peacePaull/complete-ecommerce-aspnet-mvc-application/blob/master/Images-For-Db-Initialize/Actors/BCumberbatch.jpg"
                        },
                        new Actor()
                        {
                            ...
                            ProfilePictureURL = "https://github.com/peacePaull/complete-ecommerce-aspnet-mvc-application/blob/master/Images-For-Db-Initialize/Actors/Elizabeth_Olsen.jpg"
                        },
                        new Actor()
                        {
                            FullName = "Steve Carell",
                            Bio = "Steven John Carell (born August 16, 1962) is an American actor and comedian.",
                            ProfilePictureURL = "https://github.com/peacePaull/complete-ecommerce-aspnet-mvc-application/blob/master/Images-For-Db-Initialize/Actors/Steve_Carell.jpg"
                        },
                        new Actor()
                        {
                            ...
                            ProfilePictureURL = "https://github.com/peacePaull/complete-ecommerce-aspnet-mvc-application/blob/master/Images-For-Db-Initialize/Actors/Pierre_Coffin.jpg"
                        },
                        new Actor()
                        {
                            FullName = "Robert Pattinson",
                            Bio = "Robert Douglas Thomas Pattinson(born 13 May 1986) is an English actor.",
                            ProfilePictureURL = "https://github.com/peacePaull/complete-ecommerce-aspnet-mvc-application/blob/master/Images-For-Db-Initialize/Actors/Robert_Pattinson.jpg"
                        },
                        new Actor()
                        {
                            FullName = "Zoë Kravitz",
                            Bio = "Zoë Isabella Kravitz (born December 1, 1988) is an American actress, singer, and model.",
                            ProfilePictureURL = "https://github.com/peacePaull/complete-ecommerce-aspnet-mvc-application/blob/master/Images-For-Db-Initialize/Actors/Zoe_Kravitz.jpg"
                        },
                ...
                if (!context.Producers.Any())
                {
                    context.Producers.AddRange(new List<Producer>()
                    {
                        ...
                        { 
                            ...
                            ProfilePictureURL = "https://github.com/peacePaull/complete-ecommerce-aspnet-mvc-application/blob/master/Images-For-Db-Initialize/Producers/Jerry_Bruckheimer.jpg"
                        },
                        new Producer()
                        {
                            ProducerName = "Tom Cruise",
                            Bio = "Thomas Cruise Mapother IV (born July 3, 1962), known professionally as Tom Cruise, is an American actor and producer. ",
                            ProfilePictureURL = "https://github.com/peacePaull/complete-ecommerce-aspnet-mvc-application/blob/master/Images-For-Db-Initialize/Producers/Tom_Cruise.jpg"
                        },
                        new Producer()
                        {
                            ProducerName = "Frank Marshall",
                            Bio = "Frank Wilton Marshall (born September 13, 1946) is an American film producer and director.",
                            ProfilePictureURL = "https://github.com/peacePaull/complete-ecommerce-aspnet-mvc-application/blob/master/Images-For-Db-Initialize/Producers/Frank_Marshall.jpg"
                        },
                        new Producer()
                        {
                            ...
                            ProfilePictureURL = "https://github.com/peacePaull/complete-ecommerce-aspnet-mvc-application/blob/master/Images-For-Db-Initialize/Producers/Kevin_Feige.jpg"
                        },
                        new Producer()
                        {
                            ...
                            ProfilePictureURL = "https://github.com/peacePaull/complete-ecommerce-aspnet-mvc-application/blob/master/Images-For-Db-Initialize/Producers/Chris_Meledandri.jpg"
                        },
                        new Producer()
                        {
                            ...
                            ProfilePictureURL = "https://github.com/peacePaull/complete-ecommerce-aspnet-mvc-application/blob/master/Images-For-Db-Initialize/Producers/Janet_Healy.jpg"
                        },
                        new Producer()
                        {
                            ...
                            ProfilePictureURL = "https://github.com/peacePaull/complete-ecommerce-aspnet-mvc-application/blob/master/Images-For-Db-Initialize/Producers/Chris_Renaud.jpg"
                        },
                        new Producer()
                        {
                            ...
                            ProfilePictureURL = "https://github.com/peacePaull/complete-ecommerce-aspnet-mvc-application/blob/master/Images-For-Db-Initialize/Producers/Dylan_Clark.jpg"
                        },
                        new Producer()
                        {
                            ProducerName = "Matt Reeves",
                            Bio = "Matt Reeves (born April 27, 1966) is an American film director, producer and screenwriter.",
                            ProfilePictureURL = "https://github.com/peacePaull/complete-ecommerce-aspnet-mvc-application/blob/master/Images-For-Db-Initialize/Producers/Matt_Reeves.jpg"
                        },
                ...
                if (!context.Movies.Any())
                {
                    context.Movies.AddRange(new List<Movie>() 
                    {
                        new Movie()
                        {
                            ...
                            Price = 35.5,
                            ImageURL = "https://github.com/peacePaull/complete-ecommerce-aspnet-mvc-application/blob/master/Images-For-Db-Initialize/Movies/Top_Gun_Maverick_Poster.jpg",
                        ...
                        new Movie()
                        {
                            ...
                            Price = 35.5,
                            ImageURL = "https://github.com/peacePaull/complete-ecommerce-aspnet-mvc-application/blob/master/Images-For-Db-Initialize/Movies/JurassicWorldDominion_Poster.jpeg",
                        ...
                        new Movie()
                        {
                            ...
                            Price = 35.5,
                            ImageURL = "https://github.com/peacePaull/complete-ecommerce-aspnet-mvc-application/blob/master/Images-For-Db-Initialize/Movies/Doctor_Strange_in_the_Multiverse_of_Madness_poster.jpg",
                        ...
                        new Movie()
                        {
                            ...
                            Price = 35.5,
                            ImageURL = "https://github.com/peacePaull/complete-ecommerce-aspnet-mvc-application/blob/master/Images-For-Db-Initialize/Movies/Minions_The_Rise_of_Gru_poster.jpg",
                            StartDate = DateTime.Now,
                        ...
                        new Movie()
                        {
                            ...
                            Price = 35.5,
                            ImageURL = "https://github.com/peacePaull/complete-ecommerce-aspnet-mvc-application/blob/master/Images-For-Db-Initialize/Movies/The_Batman_poster.jpg",
                            StartDate = DateTime.Now,
